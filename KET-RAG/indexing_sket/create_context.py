...
def main():
    ...
    # Free intermediate DataFrames to reduce memory before loading large parquets
    import gc
    del node_df, entity_df, entity_embedding_df, relationship_df, report_df
    del text_unit_df, text_unit_embedding_df, embedding_dict
    gc.collect()
    ...
    llm = ChatOpenAI(
        api_key=api_key,
        model=llm_model,
        api_base=os.environ.get("KET_LLM_API_BASE"),
