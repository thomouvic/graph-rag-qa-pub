...
async def main():
    ...
    llm_model = os.environ.get("KET_LLM_MODEL", "gpt-4o-mini")  # os.environ["GRAPHRAG_LLM_MODEL"]
    embedding_model = os.environ.get("KET_EMBEDDING_MODEL", "text-embedding-3-small")  # os.environ["GRAPHRAG_EMBEDDING_MODEL"]
