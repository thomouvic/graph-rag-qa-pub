"""
LightRAG generality experiment — 2WikiMHQA.
...
Stages:
    1. Index 2WikiMHQA corpus (3,258 docs) with LightRAG
...
WORK_DIR = BASE / "experiments" / "2wikimultihopqa" / "large_scale_lightrag"
...
async def index_corpus():
    """Index all 2WikiMHQA documents with LightRAG."""
...
def print_summary(results):
    print("\n" + "=" * 60)
    print("LightRAG Generality Experiment — 2WikiMHQA (70B)")
    print("=" * 60)
